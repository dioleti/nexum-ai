...
class TextBlockRegion:
    def __init__(self, bbox: Tuple[int, int, int, int]):
        self.bbox = bbox

    def __repr__(self):
        return f"TextBlockRegion(bbox={self.bbox})"
...
class BlockDetector:
    def __init__(
        ...
        min_block_area: int = 3000,
        dilation_kernel_size: Tuple[int, int] = (25, 25),
    ...
    def detect(self, gray_image: np.ndarray) -> List[TextBlockRegion]:
        ...
        detected_blocks: List[TextBlockRegion] = []
        ...
        for contour in contours:
            ...
            detected_blocks.append(
                TextBlockRegion((x, y, x + width, y + height))
            )
